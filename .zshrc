...
alias raskpdf='find /home/vaidotak/"Calibre biblioteka" -type f -name "*.pdf" -size +0 -exec du -h {} + | tee $(mktemp -u -d /tmp/pdf_knygos.XXXXXX.txt)'
alias trinkpdf='find /home/vaidotak/"Calibre biblioteka" -name "*.pdf" -mtime -1 -delete'
...
source /home/vaidotak/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
